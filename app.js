...
readMore.addEventListener("click", function () {
    ...
    if (readMore.classList.contains("clicked")) {
        aboutMeText.textContent =
            "Hey there! I'm Vivek, a  B.tech graduate and Front-end web developer . I love turning ideas into functional websites and applications. Passionate about creativity and problem-solving, I thrive on crafting seamless user experiencesMy journey in technology began with a curiosity-driven exploration of programming languages and software development. Along the way, I've honed my skills in front-end  technologies. I'm constantly seeking ways to innovate and elevate the digital experience.Outside of coding, you'll find me exploring the intersection of technology and design, experimenting with new frameworks, or immersing myself in the vibrant tech community. I thrive in collaborative environments and am always eager to learn from and share knowledge with fellow enthusiasts.";
        readMore.textContent = "Read Less";
    } else {
        aboutMeText.textContent =
            "Hey there! I'm Vivek, a B.tech graduate and Front-end web developer. I love turning ideas into functional websites and applications. Passionate about creativity and problem-solving, I thrive on crafting seamless user experiences. Let's collaborate and bring your vision to life!...";
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "vivekkumarnayan2@gmail.com",
        Password: "09F485E5249872C53B409AA7AD69D649CDE9",
        To: "vivekkumarnayan2@gmail.com",
        From: "vivekkumarnayan2@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
